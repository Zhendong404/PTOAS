...
private:
    ...
    void generateProcessingOrders(const Loop* loopOp, Occurrence* occ, bool isUseless);
    void generateProcessingOrders(const Scope* scopeOp, Occurrence* occ, bool isUseless);
    ...
    std::unique_ptr<OperationBase> getCallOp(func::CallOp, const OperationBase* parentOp) const;
    ...
    Scope* prepareBlockScope(std::unique_ptr<Scope>& scopeOp, Block& block, bool isFunctionRegion) const;
