...
static std::optional<OpcodeAndVariant> lookupOpcodeAndVariantByFullNameChunk1(llvm::StringRef fullName)
{
...
static std::optional<OpcodeAndVariant> lookupOpcodeAndVariantByFullNameChunk2(llvm::StringRef fullName)
{
    return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant> lookupOpcodeAndVariantByFullNameChunk3(llvm::StringRef fullName)
{
    return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant> lookupOpcodeAndVariantByFullNameChunk4(llvm::StringRef fullName)
{
    return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant> lookupOpcodeAndVariantByFullNameChunk5(llvm::StringRef fullName)
{
    return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant> lookupOpcodeAndVariantByFullNameChunk6(llvm::StringRef fullName)
{
    return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant> lookupOpcodeAndVariantByFullNameChunk7(llvm::StringRef fullName)
{
    return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant> lookupOpcodeAndVariantByFullNameChunk8(llvm::StringRef fullName)
{
    return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant> lookupOpcodeAndVariantByFullNameChunk9(llvm::StringRef fullName)
{
    return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant> lookupOpcodeAndVariantByFullNameChunk10(llvm::StringRef fullName)
{
    return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
        ...
        .Case("pto.section.cube", OpcodeAndVariant{0x0006, kHasVariant, kSectionCubeVariant})
        .Case("pto.section.vector", OpcodeAndVariant{0x0006, kHasVariant, kSectionVectorVariant})
        .Case("pto.tgemv", OpcodeAndVariant{0x102A, kHasVariant, kVariantDefault})
        .Case("pto.tgemv.acc", OpcodeAndVariant{0x102A, kHasVariant, kVariantAcc})
        .Case("pto.tgemv.bias", OpcodeAndVariant{0x102A, kHasVariant, kVariantBias})
        .Case("pto.tgemv.mx", OpcodeAndVariant{0x102A, kHasVariant, kVariantMx})
        .Default(std::nullopt);
}

static std::optional<OpcodeAndVariant> lookupOpcodeAndVariantByFullNameChunk11(llvm::StringRef fullName)
{
    return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
        .Case("pto.tgemv.mx.acc", OpcodeAndVariant{0x102A, kHasVariant, kVariantMxAcc})
        .Case("pto.tgemv.mx.bias", OpcodeAndVariant{0x102A, kHasVariant, kVariantMxBias})
        .Case("pto.tmatmul", OpcodeAndVariant{0x1032, kHasVariant, kVariantDefault})
        .Case("pto.tmatmul.acc", OpcodeAndVariant{0x1032, kHasVariant, kVariantAcc})
        .Case("pto.tmatmul.bias", OpcodeAndVariant{0x1032, kHasVariant, kVariantBias})
        .Case("pto.tmatmul.mx", OpcodeAndVariant{0x1033, kHasVariant, kVariantDefault})
        .Case("pto.tmatmul.mx.acc", OpcodeAndVariant{0x1033, kHasVariant, kVariantAcc})
        .Case("pto.tmatmul.mx.bias", OpcodeAndVariant{0x1033, kHasVariant, kVariantBias})
        .Default(std::nullopt);
}
...
const char* fullNameFromOpcodeVariant(uint16_t opcode, uint8_t variant)
{
    ...
    switch (opcode) {
        case 0x0006:
            switch (variant) {
                case kSectionCubeVariant:
                    return "pto.section.cube";
                case kSectionVectorVariant:
                    return "pto.section.vector";
                default:
                    return info->name;
            }
        case 0x102A:
            switch (variant) {
                case kVariantDefault:
                    return "pto.tgemv";
                case kVariantAcc:
                    return "pto.tgemv.acc";
                case kVariantBias:
                    return "pto.tgemv.bias";
                case kVariantMx:
                    return "pto.tgemv.mx";
                case kVariantMxAcc:
                    return "pto.tgemv.mx.acc";
                case kVariantMxBias:
                    return "pto.tgemv.mx.bias";
                default:
                    return info->name;
            }
        case 0x1032:
            switch (variant) {
                case kVariantDefault:
                    return "pto.tmatmul";
                case kVariantAcc:
                    return "pto.tmatmul.acc";
                case kVariantBias:
                    return "pto.tmatmul.bias";
                default:
                    return info->name;
            }
        case 0x1033:
            switch (variant) {
                case kVariantDefault:
                    return "pto.tmatmul.mx";
                case kVariantAcc:
                    return "pto.tmatmul.mx.acc";
                case kVariantBias:
                    return "pto.tmatmul.mx.bias";
                default:
                    return info->name;
            }
        default:
...
std::optional<int> lookupOperandsByVariant(uint16_t opcode, uint8_t variant)
{
    switch (opcode) {
        case 0x102A:
            switch (variant) {
                case kVariantDefault:
                    return kTgemvOperandCount;
                case kVariantAcc:
                    return kTgemvAccOperandCount;
                case kVariantBias:
                    return kTgemvBiasOperandCount;
                case kVariantMx:
                    return kTgemvMxOperandCount;
                case kVariantMxAcc:
                    return kTgemvMxAccOperandCount;
                case kVariantMxBias:
                    return kTgemvMxBiasOperandCount;
                default:
                    return std::nullopt;
            }
        case 0x1032:
            switch (variant) {
                case kVariantDefault:
                    return kTmatmulOperandCount;
                case kVariantAcc:
                    return kTmatmulAccOperandCount;
                case kVariantBias:
                    return kTmatmulBiasOperandCount;
                default:
                    return std::nullopt;
            }
        case 0x1033:
            switch (variant) {
                case kVariantDefault:
                    return kTmatmulMxOperandCount;
                case kVariantAcc:
                    return kTmatmulMxAccOperandCount;
                case kVariantBias:
                    return kTmatmulMxBiasOperandCount;
                default:
                    return std::nullopt;
            }
        default:
