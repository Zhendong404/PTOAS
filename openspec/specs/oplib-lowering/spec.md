...
- Interface-driven matching SHALL preserve legacy constraints for special cases, including compare/select family (`tcmp`, `tcmps`, `tsel`, `tsels`) dtype and mask/select-mode checks.
