// RUN: { ptoas %s --enable-op-fusion --pto-backend=vpto --pto-arch=a5 --print-ir-after-all --print-ir-after-all-func-filter=fusion_plan_dynamic_shape_negative -o /dev/null 2>&1; } | FileCheck %s
