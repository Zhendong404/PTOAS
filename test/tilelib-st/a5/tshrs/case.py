...
# PTODSL rewrite of test/tilelang_st/npu/a5/src/st/testcase/tshrs.
#   tload(src) + tshrs(src, 2) -> dst + tstore(dst)
...
def _make_kernel(name: str, np_dtype, shape, valid_shape):
    ...
    @pto.jit(name="tshrs_" + name, target="a5")
    def _kernel(
        ...
        pto.tile.bit_shrs(src_tile, scalar_val, dst_tile)
