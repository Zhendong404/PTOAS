...
# PTODSL rewrite of test/tilelang_st/npu/a5/src/st/testcase/tmul.
#
# pto.tmul: dst = a * b.  Fully-valid f32 tiles in PTODSL auto mode; tile
...
def _tmul_body(a_ptr, b_ptr, c_ptr, *, rows, cols):
    ...
    pto.tile.mul(a_tile, b_tile, c_tile)
