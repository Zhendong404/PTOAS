...
def _make_kernel(name, dtype, shape, valid_shape):
    ...
    def _kernel(
        ...
        # A5 accepts a same-shape vector scratch tile for tprelu. Keep it
        # explicit so this test exercises the public temporary-tile operand.
        ...
        pto.tile.prelu(src0_tile, src1_tile, dst_tile, tmp=tmp_tile)
