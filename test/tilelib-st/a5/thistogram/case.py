...
_U16_CASES = [
    (2, 128, "MSB", 2), (4, 64, "MSB", 2), (8, 128, "MSB", 2),
    (1, 256, "MSB", 2), (4, 256, "MSB", 2), (2, 100, "MSB", 2),
    (2, 128, "LSB", 108), (4, 64, "LSB", 52), (8, 128, "LSB", 104),
    (1, 256, "LSB", 210), (4, 256, "LSB", 220), (2, 100, "LSB", 82),
]

_U32_CASES = [
    (1, 128, 3, 64), (1, 256, 3, 128), (2, 128, 3, 100),
    (2, 4096, 3, 96), (4, 4096, 3, 128), (2, 192, 3, 64), (6, 912, 3, 64),
    (1, 128, 2, 64), (1, 256, 2, 128), (2, 128, 2, 100),
    (2, 4096, 2, 96), (4, 4096, 2, 128), (2, 192, 2, 64), (6, 912, 2, 64),
    (1, 128, 1, 64), (1, 256, 1, 128), (2, 4096, 1, 96),
    (2, 192, 1, 64), (6, 912, 1, 64),
    (1, 128, 0, 64), (1, 256, 0, 128), (2, 4096, 0, 96),
    (2, 192, 0, 64), (6, 912, 0, 64),
]
