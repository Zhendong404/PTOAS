...
"""PTODSL ST coverage for both native A5 int32 ``tdivs`` operand orders."""
...
@pto.jit(name="tdivs_i32_native_tile_scalar_1x64", target="a5")
...
@pto.jit(name="tdivs_i32_native_scalar_tile_1x64", target="a5")
...
CASES = [
    golden_output_case(
        "tdivs_i32_native_tile_scalar_1x64",
        _tile_scalar_kernel,
    ...
    golden_output_case(
        "tdivs_i32_native_scalar_tile_1x64",
        _scalar_tile_kernel,
