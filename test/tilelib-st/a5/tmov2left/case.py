...
"""PTODSL port of the legacy A5 MAT-to-LEFT TMOV case.
...
nz2nd ACC store, mirroring tload_mat).  The MAT->LEFT ``pto.tile.mov``
...
@pto.jit(name="tmov2left_f16_16x16x16", kernel_kind="cube", target="a5", mode="explicit", insert_sync=False)
...
CASES = [golden_output_case("tmov2left_f16_16x16x16", _kernel, inputs=_inputs,
