...
module {
  func.func @abs_kernel_2d(%base: !pto.ptr<f32, gm>, %ubuf: !pto.ptr<f32, ub>, %out: !pto.ptr<f32, gm>, %index: index) {
    ...
    a5vm.copy_gm_to_ubuf %base, %ubuf, %c0_i64, %c32_i64, %c128_i64, %c0_i64, %c0_i64, %cfalse, %c0_i64, %c128_i64, %c128_i64 : !pto.ptr<f32, gm>, !pto.ptr<f32, ub>, i64, i64, i64, i64, i64, i1, i64, i64, i64
    ...
    a5vm.copy_ubuf_to_gm %ubuf, %out, %c0_i64, %c32_i64, %c128_i64, %c0_i64, %c4_i64, %c128_i64 : !pto.ptr<f32, ub>, !pto.ptr<f32, gm>, i64, i64, i64, i64, i64, i64
    return
  }
}
