// RUN: { ptoas %S/generic_shape_64x32_f32.pto --op-lib-dir=%S/../../oplib/level3 --pto-arch=a5 --print-ir-after-all -o /dev/null 2>&1; } | FileCheck %s
...
// CHECK: call @__pto_oplib_inst_l3_float_binary_elementwise_template_tadd___seed__seed_l3_float_binary_elementwise_core__tadd__f32(
