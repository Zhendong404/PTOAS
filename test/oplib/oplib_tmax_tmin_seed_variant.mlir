...
// CHECK-LABEL: func.func private @__pto_oplib_inst_l3_float_binary_elementwise_template_tmin___seed__seed_l3_float_binary_elementwise_core__tmin__f32(
// CHECK-SAME: pto.oplib.instance.from_seed = true
// CHECK-SAME: pto.oplib.instance.op = "tmin"
// CHECK-LABEL: func.func private @__pto_oplib_inst_l3_float_binary_elementwise_template_tmax___seed__seed_l3_float_binary_elementwise_core__tmax__f32(
// CHECK-SAME: pto.oplib.instance.from_seed = true
