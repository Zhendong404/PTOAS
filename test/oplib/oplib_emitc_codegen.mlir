// RUN: ptoas %S/binary_max_min_chain.pto --pto-arch=a5 -o %t.bin6.cpp
// RUN: FileCheck %s --check-prefix=BIN6 < %t.bin6.cpp
// RUN: ptoas %S/softmax_chain.pto --pto-arch=a5 -o %t.softmax.cpp
...
// RUN: ptoas %S/binary_max_min_chain.pto --pto-arch=a5 -o %t.attr.cpp
