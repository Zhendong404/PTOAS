...
// RUN: ! ptoas %S/compare_family.pto --enable-op-fusion --pto-arch=a5 -o %t.bad_manifest.cpp > %t.bad_manifest.log 2>&1
...
// RUN: ! ptoas %S/compare_family.pto --enable-op-fusion --pto-arch=a5 -o %t.bad_template.cpp > %t.bad_template.log 2>&1
...
// RUN: ! ptoas %S/compare_family.pto --enable-op-fusion --pto-arch=a5 -o %t.no_candidate.cpp > %t.no_candidate.log 2>&1
...
// RUN: ! ptoas %S/compare_family.pto --enable-op-fusion --pto-arch=a5 -o %t.bad_rewrite.cpp > %t.bad_rewrite.log 2>&1
