...
// RUN: ! ptoas %s --enable-op-fusion --op-lib-dir=%t.dir --pto-arch=a5 -o /dev/null > %t.log 2>&1
// RUN: FileCheck %s < %t.log

// CHECK: reduce_colsum variant_id=binary is not implemented in OP-Lib; refuse to fall back to linear

module {
  func.func @reject_reduce_colsum_binary_variant() {
