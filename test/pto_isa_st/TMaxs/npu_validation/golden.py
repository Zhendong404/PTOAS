...
CASES = {
    "tmaxs_float_64x64_32x32_32x32": {"dtype": "f32", "dst": (64, 64), "src": (32, 32), "valid": (32, 32), "pad": "null"},
    "tmaxs_float_128x128_64x64_64x64": {"dtype": "f32", "dst": (128, 128), "src": (64, 64), "valid": (64, 64), "pad": "null"},
    "tmaxs_float_60x128_64x64_60x60_padmax": {"dtype": "f32", "dst": (60, 128), "src": (64, 64), "valid": (60, 60), "pad": "max"},
    "tmaxs_float_16x200_20x512_16x200_padmax": {"dtype": "f32", "dst": (16, 200), "src": (20, 512), "valid": (16, 200), "pad": "max"},
    "tmaxs_float_1x3600_2x4096_1x3600_padmax": {"dtype": "f32", "dst": (1, 3600), "src": (2, 4096), "valid": (1, 3600), "pad": "max"},
    "tmaxs_int32_32x32_32x32_32x32": {"dtype": "i32", "dst": (32, 32), "src": (32, 32), "valid": (32, 32), "pad": "null"},
    "tmaxs_uint32_32x32_32x32_32x32": {"dtype": "u32", "dst": (32, 32), "src": (32, 32), "valid": (32, 32), "pad": "null"},
    "tmaxs_int16_32x128_32x128_32x128": {"dtype": "i16", "dst": (32, 128), "src": (32, 128), "valid": (32, 128), "pad": "null"},
    "tmaxs_uint16_32x128_32x128_32x128": {"dtype": "u16", "dst": (32, 128), "src": (32, 128), "valid": (32, 128), "pad": "null"},
    "tmaxs_int8_32x128_32x128_32x128": {"dtype": "i8", "dst": (32, 128), "src": (32, 128), "valid": (32, 128), "pad": "null"},
    "tmaxs_uint8_32x128_32x128_32x128": {"dtype": "u8", "dst": (32, 128), "src": (32, 128), "valid": (32, 128), "pad": "null"},
    "tmaxs_half_16x256_20x224_16x200_padmax": {"dtype": "f16", "dst": (16, 256), "src": (20, 224), "valid": (16, 200), "pad": "max"},
}
...
def main():
    ...
    if "scalar" == "binary":
        ...
        out[:valid_rows, :valid_cols] = np.maximum(src[:valid_rows, :valid_cols], scalar)
