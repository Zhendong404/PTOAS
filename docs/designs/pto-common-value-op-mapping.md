...
[Scalar and Builtin Vector Value Operations](../isa/micro-isa/14-shared-arith.md).
...
| `arith.mulsi_extended`, `arith.mului_extended` | `pto.mul_extended signed/unsigned` | **Covered** | One two-result operation carries explicit integer interpretation. |
...
| `arith.divsi`, `arith.divui` | `pto.divi signed/unsigned` | **Covered** | Signed division rounds toward zero; unsigned division uses unsigned interpretation. |
| `arith.floordivsi`, unsigned floor division | `pto.floordiv signed/unsigned` | **Covered** | Signed floor division rounds toward negative infinity; unsigned floor division is equivalent to unsigned division. |
| `arith.ceildivsi`, `arith.ceildivui` | `pto.ceildiv signed/unsigned` | **Covered** | The attribute selects signed or unsigned ceiling division. |
| `arith.remsi`, `arith.remui` | `pto.remi signed/unsigned` | **Covered** | The attribute selects signed or unsigned remainder. |
