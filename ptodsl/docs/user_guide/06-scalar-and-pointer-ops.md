...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.mixed_expression"} -->
```python
...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.load.tile_form"} -->
```python
...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.load.pointer_forms"} -->
```python
...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.store.tile_form"} -->
```python
...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.store.pointer_form"} -->
```python
...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.simt_blend_usage"} -->
```python
@pto.simt
...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.arith.example"} -->
```python
...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.math.example"} -->
```python
...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.alias.example"} -->
```python
scalar = pto.scalar
...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.as_ptr"} -->
```python
...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.addptr"} -->
```python
...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.bytewidth"} -->
```python
...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.elements_per_vreg"} -->
```python
...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.chunk_stride"} -->
```python
...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.elementwise_scale"} -->
```python
@pto.simt
...
<!-- ptodsl-doc-test: {"mode":"excerpt","source":"scalar_pointer.per_row_coeffs"} -->
```python
@pto.simt
