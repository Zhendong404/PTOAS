...
def cast(value, dtype, *, rounding=None, saturation=None, overflow=None, fastmath=None):
    ...
    Index/integer conversions use the authored integer signedness and lower
    directly to ``arith.index_cast`` or ``arith.index_castui``. Numeric
    conversion attributes are not valid for this conversion category.
    """
