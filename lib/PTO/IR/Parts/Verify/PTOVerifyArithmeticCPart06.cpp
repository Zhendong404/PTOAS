...
static LogicalResult verifyTGatherForArch(TGatherOp op, bool allowA5Forms)
{
    ...
    return verifyGatherIndexForm(
        op, /*allow16BitIndices=*/allowA5Forms,
        /*allowA5ElemTypes=*/allowA5Forms);
}

llvm::LogicalResult mlir::pto::TGatherOp::verify()
{
    auto verifyA2A3 = [this]() -> LogicalResult { return verifyTGatherForArch(*this, false); };
    auto verifyA5 = [this]() -> LogicalResult { return verifyTGatherForArch(*this, true); };
...
mlir::LogicalResult mlir::pto::TGatherBOp::verify()
{
    auto verifyCommon = [this]() -> FailureOr<std::pair<Type, Type>> {
        ...
        if (failed(verifyTileBufCommon(*this, srcTy, "src")) || failed(verifyTileBufCommon(*this, offTy, "offsets")) ||
...
mlir::LogicalResult mlir::pto::TLReluOp::verify()
{
    ...
    auto verifyA2A3 = [this, srcTy, dstTy]() -> LogicalResult {
        if (failed(verifyVecTileStorage(*this, srcTy, "src")) || failed(verifyVecTileStorage(*this, dstTy, "dst")))
            return failure();
...
mlir::LogicalResult mlir::pto::TMaxOp::verify()
{
    return verifyArithmeticBinaryTileOpWithArchDispatch(
        ...
        /*allowInt8OnA5=*/true, /*allowBf16OnA5=*/false, "expects A2/A3 tmax element type to be i32/i16/f16/f32",
...
mlir::LogicalResult mlir::pto::TMaxSOp::verify()
{
    return verifyArithmeticScalarTileOpWithArchDispatch(
        ...
        /*allowInt8OnA5=*/true, /*allowBf16OnA5=*/true, "expects A2/A3 tmaxs element type to be i32/i16/f16/f32",
...
mlir::LogicalResult mlir::pto::TMinOp::verify()
{
    return verifyArithmeticBinaryTileOpWithArchDispatch(
        getOperation(), getSrc0().getType(), getSrc1().getType(), getDst().getType(),
        /*allowInt8OnA5=*/true, /*allowBf16OnA5=*/true, "expects A2/A3 tmin element type to be i32/i16/f16/f32",
...
mlir::LogicalResult mlir::pto::TMinSOp::verify()
{
    return verifyArithmeticScalarTileOpWithArchDispatch(
        getOperation(), getSrc().getType(), getDst().getType(), getScalar().getType(),
        /*allowInt8OnA5=*/true, /*allowBf16OnA5=*/true, "expects A2/A3 tmins element type to be i32/i16/f16/f32",
