...
[[maybe_unused]] static std::string maskPatternTok(mlir::pto::MaskPatternAttr a)
{
    ...
    return (std::string("pto::MaskPattern::") + mlir::pto::stringifyMaskPattern(value).str());
}

template <typename RowExpandOp, typename AdaptorT>
static LogicalResult lowerRowExpandBinaryLikeOp(
    RowExpandOp op, AdaptorT adaptor, StringRef callee, ConversionPatternRewriter* rewriter)
{
...
struct PTOMovFPToEmitC : public OpConversionPattern<pto::TMovFPOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TMovFPOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOQuantToEmitC : public OpConversionPattern<pto::TQuantOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TQuantOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        auto* ctx = rewriter.getContext();
        ...
        if (op.getOffset()) {
            ...
            if (offsetOT) {
                offsetPtr =
                    rewriter.create<emitc::ApplyOp>(loc, emitc::PointerType::get(offsetOT), "&", offset).getResult();
            }
        }

        // TQUANT<QuantType, DstTile, SrcTile, FpTile>(dst, src, fp[, &offset])
        std::string quantTypeStr =
            op.getQuantType() == pto::QuantType::INT8_SYM ? "pto::QuantType::INT8_SYM" : "pto::QuantType::INT8_ASYM";
        ArrayAttr templateArgs;
        auto dstOT = mlir::dyn_cast<emitc::OpaqueType>(dst.getType());
        auto srcOT = mlir::dyn_cast<emitc::OpaqueType>(src.getType());
        auto fpOT = mlir::dyn_cast<emitc::OpaqueType>(fp.getType());
...
struct PTODequantToEmitC : public OpConversionPattern<pto::TDequantOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TDequantOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        auto* ctx = rewriter.getContext();
...
struct PTOMrgSortToEmitC : public OpConversionPattern<pto::TMrgSortOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TMrgSortOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        if (op.isFormat1()) {
            ...
            rewriter.create<emitc::CallOpaqueOp>(loc, TypeRange{}, "TMRGSORT", ArrayAttr{}, ArrayAttr{}, operands);
...
struct PTOMulToEmitC : public OpConversionPattern<pto::TMulOp> {
    ...
    LogicalResult matchAndRewrite(pto::TMulOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOMulsToEmitC : public OpConversionPattern<pto::TMulSOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TMulSOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTONegToEmitC : public OpConversionPattern<pto::TNegOp> {
    ...
    LogicalResult matchAndRewrite(pto::TNegOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTONotToEmitC : public OpConversionPattern<pto::TNotOp> {
    ...
    LogicalResult matchAndRewrite(pto::TNotOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOOrToEmitC : public OpConversionPattern<pto::TOrOp> {
    ...
    LogicalResult matchAndRewrite(pto::TOrOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOOrsToEmitC : public OpConversionPattern<pto::TOrSOp> {
    ...
    LogicalResult matchAndRewrite(pto::TOrSOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOPartAddToEmitC : public OpConversionPattern<pto::TPartAddOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TPartAddOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOPartMaxToEmitC : public OpConversionPattern<pto::TPartMaxOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TPartMaxOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOPartMinToEmitC : public OpConversionPattern<pto::TPartMinOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TPartMinOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOPartArgMaxToEmitC : public OpConversionPattern<pto::TPartArgMaxOp> {
    using OpConversionPattern<pto::TPartArgMaxOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::TPartArgMaxOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        Value src0 = peelUnrealized(adaptor.getSrc0());
        Value src1 = peelUnrealized(adaptor.getSrc1());
...
struct PTOPartArgMinToEmitC : public OpConversionPattern<pto::TPartArgMinOp> {
    using OpConversionPattern<pto::TPartArgMinOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::TPartArgMinOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        Value src0 = peelUnrealized(adaptor.getSrc0());
        Value src1 = peelUnrealized(adaptor.getSrc1());
        Value src0Idx = peelUnrealized(adaptor.getSrc0Idx());
...
struct PTOPartMulToEmitC : public OpConversionPattern<pto::TPartMulOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TPartMulOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOPreluToEmitC : public OpConversionPattern<pto::TPReluOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TPReluOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTORecipToEmitC : public OpConversionPattern<pto::TRecipOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TRecipOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOReluToEmitC : public OpConversionPattern<pto::TReluOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TReluOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTORemToEmitC : public OpConversionPattern<pto::TRemOp> {
    ...
    LogicalResult matchAndRewrite(pto::TRemOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOFModToEmitC : public OpConversionPattern<pto::TFModOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TFModOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTORemSToEmitC : public OpConversionPattern<pto::TRemSOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TRemSOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOFModSToEmitC : public OpConversionPattern<pto::TFModSOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TFModSOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTORowExpandToEmitC : public OpConversionPattern<pto::TRowExpandOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TRowExpandOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTORowExpandAddToEmitC : public OpConversionPattern<pto::TRowExpandAddOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TRowExpandAddOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        return lowerRowExpandBinaryNoTmpOp(op, adaptor, "TROWEXPANDADD", &rewriter);
    }
};

struct PTORowExpandExpdifToEmitC : public OpConversionPattern<pto::TRowExpandExpdifOp> {
    using OpConversionPattern<pto::TRowExpandExpdifOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::TRowExpandExpdifOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
...
static void replaceOrEraseWithOpaqueCall(
    Operation* op, StringRef callee, ArrayRef<Value> args, ConversionPatternRewriter& rewriter)
{
...
static void replaceOrEraseWithOpaqueCallAndReturnDst(
    Operation* op, Value dst, StringRef callee, ArrayRef<Value> args, ConversionPatternRewriter& rewriter)
{
    rewriter.create<emitc::CallOpaqueOp>(op->getLoc(), TypeRange{}, callee, ArrayAttr{}, ArrayAttr{}, ValueRange(args));
...
static void emitBinaryThenAccumulate(
    ConversionPatternRewriter& rewriter, Location loc, StringRef firstCallee, Value dst, Value lhs, Value rhs,
    Value acc)
{
    rewriter.create<emitc::CallOpaqueOp>(
...
struct PTOTGemvBiasToTGEMV_BIAS : public OpConversionPattern<pto::TGemvBiasOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TGemvBiasOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        ...
        replaceOrEraseWithOpaqueCall(op.getOperation(), "TGEMV_BIAS", {dst, a, b, bias}, rewriter);
        return success();
    }
};

struct PTOTGemvMXToTGEMV_MX : public OpConversionPattern<pto::TGemvMxOp> {
    using OpConversionPattern<pto::TGemvMxOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::TGemvMxOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        Value a = peelUnrealized(adaptor.getA());
        ...
        replaceOrEraseWithOpaqueCallAndReturnDst(
            op.getOperation(), dst, "TGEMV_MX", {dst, a, aScale, b, bScale}, rewriter);
        return success();
    }
};

struct PTOTGemvMXAccToTGEMV_MX : public OpConversionPattern<pto::TGemvMxAccOp> {
    using OpConversionPattern<pto::TGemvMxAccOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::TGemvMxAccOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        ...
        replaceOrEraseWithOpaqueCallAndReturnDst(
            op.getOperation(), dst, "TGEMV_MX", {dst, cIn, a, aScale, b, bScale}, rewriter);
        return success();
    }
};

struct PTOTGemvMXBiasToTGEMV_MX : public OpConversionPattern<pto::TGemvMxBiasOp> {
    using OpConversionPattern<pto::TGemvMxBiasOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::TGemvMxBiasOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        Value a = peelUnrealized(adaptor.getA());
        Value aScale = peelUnrealized(adaptor.getAScale());
        Value b = peelUnrealized(adaptor.getB());
        ...
        replaceOrEraseWithOpaqueCallAndReturnDst(
            op.getOperation(), dst, "TGEMV_MX", {dst, a, aScale, b, bScale, bias}, rewriter);
        return success();
    }
};

struct PTOTMatmulBiasToTMATMUL_BIAS : public OpConversionPattern<pto::TMatmulBiasOp> {
    using OpConversionPattern<pto::TMatmulBiasOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::TMatmulBiasOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        Value a = peelUnrealized(adaptor.getA());
        Value b = peelUnrealized(adaptor.getB());
        Value bias = peelUnrealized(adaptor.getBias());
        ...
        replaceOrEraseWithOpaqueCall(op.getOperation(), "TMATMUL_BIAS", {dst, a, b, bias}, rewriter);
        return success();
    }
};
...
struct PTOTMatmulMXToTMATMUL_MX : public OpConversionPattern<pto::TMatmulMxOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TMatmulMxOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        Value a = peelUnrealized(adaptor.getA());
        Value aScale = peelUnrealized(adaptor.getAScale());
        Value b = peelUnrealized(adaptor.getB());
        ...
        replaceOrEraseWithOpaqueCall(op.getOperation(), "TMATMUL_MX", {dst, a, aScale, b, bScale}, rewriter);
        return success();
    }
};

struct PTOTMatmulMXAccToTMATMUL_MX_ACC : public OpConversionPattern<pto::TMatmulMxAccOp> {
    using OpConversionPattern<pto::TMatmulMxAccOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::TMatmulMxAccOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        Value cIn = peelUnrealized(adaptor.getCIn());
        Value a = peelUnrealized(adaptor.getA());
        Value aScale = peelUnrealized(adaptor.getAScale());
        ...
        replaceOrEraseWithOpaqueCall(op.getOperation(), "TMATMUL_MX", {dst, cIn, a, aScale, b, bScale}, rewriter);
        return success();
    }
};

struct PTOTMatmulMXBiasToTMATMUL_MX_BIAS : public OpConversionPattern<pto::TMatmulMxBiasOp> {
    using OpConversionPattern<pto::TMatmulMxBiasOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::TMatmulMxBiasOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        Value a = peelUnrealized(adaptor.getA());
        Value aScale = peelUnrealized(adaptor.getAScale());
        Value b = peelUnrealized(adaptor.getB());
        ...
        replaceOrEraseWithOpaqueCall(op.getOperation(), "TMATMUL_MX", {dst, a, aScale, b, bScale, bias}, rewriter);
        return success();
    }
};
...
struct PTORowExpandDivToEmitC : public OpConversionPattern<pto::TRowExpandDivOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TRowExpandDivOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
...
struct PTORowExpandMulToEmitC : public OpConversionPattern<pto::TRowExpandMulOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TRowExpandMulOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
...
struct PTORowExpandSubToEmitC : public OpConversionPattern<pto::TRowExpandSubOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TRowExpandSubOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
...
struct PTORowExpandMaxToEmitC : public OpConversionPattern<pto::TRowExpandMaxOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TRowExpandMaxOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
...
struct PTORowExpandMinToEmitC : public OpConversionPattern<pto::TRowExpandMinOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TRowExpandMinOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
...
struct PTORowMaxToEmitC : public OpConversionPattern<pto::TRowMaxOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TRowMaxOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTORowArgMaxToEmitC : public OpConversionPattern<pto::TRowArgMaxOp> {
    using OpConversionPattern<pto::TRowArgMaxOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::TRowArgMaxOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTORowMinToEmitC : public OpConversionPattern<pto::TRowMinOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TRowMinOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTORowArgMinToEmitC : public OpConversionPattern<pto::TRowArgMinOp> {
    using OpConversionPattern<pto::TRowArgMinOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::TRowArgMinOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTORowSumToEmitC : public OpConversionPattern<pto::TRowSumOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TRowSumOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTORowProdToEmitC : public OpConversionPattern<pto::TRowProdOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TRowProdOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTORsqrtToEmitC : public OpConversionPattern<pto::TRsqrtOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TRsqrtOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOScatterToEmitC : public OpConversionPattern<pto::TScatterOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TScatterOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        ...
        if (hasMaskPattern == hasIndexes) {
            return rewriter.notifyMatchFailure(op, "expected exactly one of indexes operand or maskPattern attribute");
        }
...
struct PTOSelToEmitC : public OpConversionPattern<pto::TSelOp> {
    ...
    LogicalResult matchAndRewrite(pto::TSelOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOSelSToEmitC : public OpConversionPattern<pto::TSelSOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TSelSOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOShlSToEmitC : public OpConversionPattern<pto::TShlOp> {
    ...
    LogicalResult matchAndRewrite(pto::TShlOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOShrSToEmitC : public OpConversionPattern<pto::TShrOp> {
    ...
    LogicalResult matchAndRewrite(pto::TShrOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOShlSConstToEmitC : public OpConversionPattern<pto::TShlSOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TShlSOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        Value dst = peelUnrealized(adaptor.getDst());
        Value src = peelUnrealized(adaptor.getSrc());
...
struct PTOShrSConstToEmitC : public OpConversionPattern<pto::TShrSOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TShrSOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        Value dst = peelUnrealized(adaptor.getDst());
        Value src = peelUnrealized(adaptor.getSrc());
...
struct PTOSORT32SToEmitC : public OpConversionPattern<pto::TSort32Op> {
    ...
    LogicalResult matchAndRewrite(
        pto::TSort32Op op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOSqrtSToEmitC : public OpConversionPattern<pto::TSqrtOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TSqrtOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOStoreFPSToEmitC : public OpConversionPattern<pto::TStoreFPOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TStoreFPOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        ...
        if (auto dstMrTy = dyn_cast<MemRefType>(op.getDst().getType())) {
            ...
            if (isGlobal) {
                if (Value gt = buildGlobalTensorFromMemref(rewriter, loc, dst, dstMrTy, op.getOperation()))
                    dstArg = gt;
            }
        }
...
struct PTOSubSToEmitC : public OpConversionPattern<pto::TSubOp> {
    ...
    LogicalResult matchAndRewrite(pto::TSubOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOSubCSToEmitC : public OpConversionPattern<pto::TSubCOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TSubCOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOSubSSToEmitC : public OpConversionPattern<pto::TSubSOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TSubSOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOSubSCToEmitC : public OpConversionPattern<pto::TSubSCOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TSubSCOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOXORToEmitC : public OpConversionPattern<pto::TXorOp> {
    ...
    LogicalResult matchAndRewrite(pto::TXorOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOTTransToEmitC : public OpConversionPattern<pto::TTransOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TTransOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOXORSToEmitC : public OpConversionPattern<pto::TXorSOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TXorSOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOPrintToTPRINT : public OpConversionPattern<pto::TPrintOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TPrintOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
    ...
    RewritePatternSet& patterns, TypeConverter& typeConverter, MLIRContext* ctx)
{
    ...
    patterns.add<
        PTOTMatmulBiasToTMATMUL_BIAS, PTOTMatmulMXToTMATMUL_MX, PTOTMatmulMXAccToTMATMUL_MX_ACC,
        PTOTMatmulMXBiasToTMATMUL_MX_BIAS, PTOTGemvBiasToTGEMV_BIAS, PTOTGemvMXToTGEMV_MX, PTOTGemvMXAccToTGEMV_MX,
        PTOTGemvMXBiasToTGEMV_MX>(typeConverter, ctx);
}

void populatePTOToEmitCTileExtraPatterns(RewritePatternSet& patterns, TypeConverter& typeConverter, MLIRContext* ctx)
{
