...
bool MemoryDependentAnalyzer::MemAlias(const BaseMemInfo* a, const BaseMemInfo* b) const
{
    ...
    if (isTraceEnabled()) {
        ...
        llvm::errs() << "    Scope A: " << static_cast<int>(as) << ", Scope B: " << static_cast<int>(bs) << "\n";
    }
...
bool MemoryDependentAnalyzer::isGMBufferOverlap(const BaseMemInfo* a, const BaseMemInfo* b) const
{
    if (a->rootBuffer != b->rootBuffer) {
        Value realRootA = GetRealRoot(a->rootBuffer);
        Value realRootB = GetRealRoot(b->rootBuffer);
...
bool MemoryDependentAnalyzer::isBufferAddressRangeOverlap(const BaseMemInfo* a, const BaseMemInfo* b) const
{
...
bool MemoryDependentAnalyzer::isBufferOverlap(const BaseMemInfo* a, const BaseMemInfo* b, int aIndex, int bIndex) const
{
