...
struct PTOGetBlockIdxToEmitC : public OpConversionPattern<mlir::pto::GetBlockIdxOp> {
    using OpConversionPattern<mlir::pto::GetBlockIdxOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        mlir::pto::GetBlockIdxOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        rewriter.replaceOpWithNewOp<emitc::CallOpaqueOp>(
            op, op.getType(), "get_block_idx", ValueRange{}, ArrayAttr{}, ArrayAttr{});
...
struct PTOGetBlockNumToEmitC : public OpConversionPattern<mlir::pto::GetBlockNumOp> {
    using OpConversionPattern<mlir::pto::GetBlockNumOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        mlir::pto::GetBlockNumOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        rewriter.replaceOpWithNewOp<emitc::CallOpaqueOp>(
            op, op.getType(), "get_block_num", ValueRange{}, ArrayAttr{}, ArrayAttr{});
...
struct PTOGetSubBlockIdxToEmitC : public OpConversionPattern<mlir::pto::GetSubBlockIdxOp> {
    using OpConversionPattern<mlir::pto::GetSubBlockIdxOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        mlir::pto::GetSubBlockIdxOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        rewriter.replaceOpWithNewOp<emitc::CallOpaqueOp>(
            op, op.getType(), "get_subblockid", ValueRange{}, ArrayAttr{}, ArrayAttr{});
...
struct PTOGetSubBlockNumToEmitC : public OpConversionPattern<mlir::pto::GetSubBlockNumOp> {
    using OpConversionPattern<mlir::pto::GetSubBlockNumOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        mlir::pto::GetSubBlockNumOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        rewriter.replaceOpWithNewOp<emitc::CallOpaqueOp>(
            op, op.getType(), "get_subblockdim", ValueRange{}, ArrayAttr{}, ArrayAttr{});
...
struct PTOSetValToSETVAL : public OpConversionPattern<pto::TSetValOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TSetValOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        ...
        rewriter.create<emitc::CallOpaqueOp>(
            op.getLoc(), TypeRange{}, "PTOAS__TILE_SET_VALUE", ArrayAttr{}, ArrayAttr{}, ValueRange{dst, offset, val});
...
struct PTOGetValToGETVAL : public OpConversionPattern<pto::TGetValOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TGetValOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        ...
        auto call = rewriter.create<emitc::CallOpaqueOp>(
            op.getLoc(), TypeRange{dstTy}, "PTOAS__TILE_GET_VALUE", ArrayAttr{}, ArrayAttr{}, ValueRange{src, offset});
...
struct PTOTAxpyToEmitC : public OpConversionPattern<pto::TAxpyOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TAxpyOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOHistogramToEmitC : public OpConversionPattern<pto::THistogramOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::THistogramOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        ...
        auto templateArgs = rewriter.getArrayAttr(
            {emitc::OpaqueAttr::get(ctx, op.getIsMSB() ? "HistByte::BYTE_1" : "HistByte::BYTE_0")});
        rewriter.create<emitc::CallOpaqueOp>(
...
struct PTOGetScaleAddrToEmitC : public OpConversionPattern<pto::TGetScaleAddrOp> {
    using OpConversionPattern<pto::TGetScaleAddrOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::TGetScaleAddrOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOSetValidShapeToEmitC : public OpConversionPattern<pto::SetValidShapeOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::SetValidShapeOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        ...
        if (!isEmitCTileLikeValue(src))
            return rewriter.notifyMatchFailure(op, "set_validshape source must lower to a tile-like value");

        rewriter.create<emitc::CallOpaqueOp>(
            op.getLoc(), TypeRange{}, "PTOAS__TILE_SET_VALIDSHAPE", ArrayAttr{}, ArrayAttr{},
            ValueRange{src, row, col});
...
struct PTOGetValidShapeToEmitC : public OpConversionPattern<pto::GetValidShapeOp> {
    using OpConversionPattern<pto::GetValidShapeOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::GetValidShapeOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        Value src = peelEmitCCasts(adaptor.getSource());
        if (!isEmitCTileLikeValue(src))
            return rewriter.notifyMatchFailure(op, "get_validshape source must lower to a tile-like value");
        ...
        Value row =
            rewriter
                .create<emitc::CallOpaqueOp>(
                    op.getLoc(), resultTy, "PTOAS__TILE_GET_VALID_ROW", ArrayAttr{}, ArrayAttr{}, ValueRange{src})
                .getResult(0);
        Value col =
            rewriter
                .create<emitc::CallOpaqueOp>(
                    op.getLoc(), resultTy, "PTOAS__TILE_GET_VALID_COL", ArrayAttr{}, ArrayAttr{}, ValueRange{src})
                .getResult(0);
...
struct PTOTAssignToEmitC : public OpConversionPattern<pto::TAssignOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TAssignOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        Value tile = peelEmitCCasts(adaptor.getTile());
        if (!isEmitCTileLikeValue(tile))
            return rewriter.notifyMatchFailure(op, "tassign tile must lower to a tile-like value");

        rewriter.create<emitc::CallOpaqueOp>(
            loc, TypeRange{}, "TASSIGN", ArrayAttr{}, ArrayAttr{},
            ValueRange{tile, castAddressToU64(rewriter, loc, peelUnrealized(adaptor.getAddr()))});
...
struct PTOPtrToIntToEmitC : public OpConversionPattern<pto::PtrToIntOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::PtrToIntOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        ...
        auto cast = rewriter.create<emitc::CallOpaqueOp>(
            op.getLoc(), dstTy, "reinterpret_cast", ArrayAttr{}, templateArgs, ValueRange{ptr});
...
struct PTOIntToPtrToEmitC : public OpConversionPattern<pto::IntToPtrOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::IntToPtrOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        ...
        std::string castType = std::string("__gm__ ") + getEmitCScalarTypeToken(dstElemTy) + "*";
        auto templateArgs = rewriter.getArrayAttr({emitc::OpaqueAttr::get(rewriter.getContext(), castType)});
        auto cast = rewriter.create<emitc::CallOpaqueOp>(
            op.getLoc(), dstTy, "reinterpret_cast", ArrayAttr{}, templateArgs, ValueRange{addr});
        rewriter.replaceOp(op, cast.getResult(0));
        return success();
    }
};
...
struct PTOLoadScalarToEmitC : public OpConversionPattern<pto::LoadScalarOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::LoadScalarOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        Value ptr = peelUnrealized(adaptor.getPtr());
        Value offset = peelUnrealized(adaptor.getOffset());
        ...
        auto call = rewriter.create<emitc::CallOpaqueOp>(
            op.getLoc(), TypeRange{dstTy}, "PTOAS__PTR_LOAD", ArrayAttr{}, ArrayAttr{}, ValueRange{ptr, offset});
...
struct PTOStoreScalarToEmitC : public OpConversionPattern<pto::StoreScalarOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::StoreScalarOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        Value ptr = peelUnrealized(adaptor.getPtr());
        Value offset = peelUnrealized(adaptor.getOffset());
        ...
        rewriter.create<emitc::CallOpaqueOp>(
            op.getLoc(), TypeRange{}, "PTOAS__PTR_STORE", ArrayAttr{}, ArrayAttr{}, ValueRange{ptr, offset, val});
...
struct PTOTAbsToTABS : public OpConversionPattern<pto::TAbsOp> {
    ...
    LogicalResult matchAndRewrite(pto::TAbsOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        Value src = peelUnrealized(adaptor.getSrc());
        Value dst = peelUnrealized(adaptor.getDst());
        ...
        rewriter.create<emitc::CallOpaqueOp>(
            op.getLoc(), TypeRange{}, "TABS", ArrayAttr{}, ArrayAttr{}, ValueRange{dst, src});
...
struct PTOTAddToTADD : public OpConversionPattern<pto::TAddOp> {
    ...
    LogicalResult matchAndRewrite(pto::TAddOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        ...
        rewriter.create<emitc::CallOpaqueOp>(
            op.getLoc(), TypeRange{}, "TADD", ArrayAttr{}, ArrayAttr{}, ValueRange{dst, src0, src1});
...
struct AffineApplyMulConstToEmitC : public OpConversionPattern<affine::AffineApplyOp> {
    using OpConversionPattern<affine::AffineApplyOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        affine::AffineApplyOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        ...
        auto cstOp = rewriter.create<emitc::ConstantOp>(op.getLoc(), inputVal.getType(), cstAttr);

        rewriter.replaceOpWithNewOp<emitc::MulOp>(op, inputVal.getType(), inputVal, cstOp);
...
void populatePTOToEmitCSimpleOpPatterns(RewritePatternSet& patterns, TypeConverter& typeConverter, MLIRContext* ctx)
{
    ...
    patterns.add<
        PTOSetValToSETVAL, PTOGetValToGETVAL, PTOSetValidShapeToEmitC, PTOGetValidShapeToEmitC, PTOTAssignToEmitC,
        PTOPtrToIntToEmitC, PTOIntToPtrToEmitC, PTOLoadScalarToEmitC, PTOStoreScalarToEmitC>(typeConverter, ctx);
    patterns.add<PTOTAxpyToEmitC, PTOHistogramToEmitC, PTOGetScaleAddrToEmitC>(typeConverter, ctx);
