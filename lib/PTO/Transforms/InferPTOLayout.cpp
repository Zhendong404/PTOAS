...
static bool isGlobalMemRef(MemRefType memRefType) {
  auto ms = dyn_cast_or_null<AddressSpaceAttr>(memRefType.getMemorySpace());
  return ms && ms.getAddressSpace() == AddressSpace::GM;
}
