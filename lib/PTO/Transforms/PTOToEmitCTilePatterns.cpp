...
static LogicalResult lowerTDivSLikeOp(
    pto::TDivSOp op, pto::TDivSOp::Adaptor adaptor, ConversionPatternRewriter& rewriter)
{
    auto loc = op.getLoc();
    ...
    rewriter.create<emitc::CallOpaqueOp>(
        loc, TypeRange{}, "TDIVS", ArrayAttr{}, ArrayAttr{}, ValueRange{dst, src, scalar});
    rewriter.eraseOp(op);
    return success();
}
...
struct PTOTAndToEmitC : public OpConversionPattern<pto::TAndOp> {
    ...
    LogicalResult matchAndRewrite(pto::TAndOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        ...
        rewriter.create<emitc::CallOpaqueOp>(
            op.getLoc(), TypeRange{}, "TAND", ArrayAttr{}, ArrayAttr{}, ValueRange{dst, a, b});
...
struct PTOConcatToEmitC : public OpConversionPattern<pto::TConcatOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TConcatOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        ...
        rewriter.create<emitc::CallOpaqueOp>(
            op.getLoc(), TypeRange{}, "TCONCAT", ArrayAttr{}, ArrayAttr{}, ValueRange{dst, src0, src1});
...
struct PTOConcatidxToEmitC : public OpConversionPattern<pto::TConcatidxOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TConcatidxOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        Value src0 = peelUnrealized(adaptor.getSrc0());
        Value src1 = peelUnrealized(adaptor.getSrc1());
        ...
        rewriter.create<emitc::CallOpaqueOp>(
            op.getLoc(), TypeRange{}, "TCONCAT", ArrayAttr{}, ArrayAttr{},
...
struct PTOAndSToEmitC : public OpConversionPattern<pto::TAndSOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TAndSOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        Value src = peelUnrealized(adaptor.getSrc());
        Value scalar = peelUnrealized(adaptor.getScalar());
        Value dst = peelUnrealized(adaptor.getDst());
        ...
        rewriter.create<emitc::CallOpaqueOp>(
            op.getLoc(), TypeRange{}, "TANDS", ArrayAttr{}, ArrayAttr{}, ValueRange{dst, src, scalar});
...
struct PTOTCIToEmitC : public OpConversionPattern<pto::TCIOp> {
    ...
    LogicalResult matchAndRewrite(pto::TCIOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOColExpandToEmitC : public OpConversionPattern<pto::TColExpandOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TColExpandOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOColExpandMulToEmitC : public OpConversionPattern<pto::TColExpandMulOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TColExpandMulOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOColExpandAddToEmitC : public OpConversionPattern<pto::TColExpandAddOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TColExpandAddOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOColExpandDivToEmitC : public OpConversionPattern<pto::TColExpandDivOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TColExpandDivOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOColExpandExpdifToEmitC : public OpConversionPattern<pto::TColExpandExpdifOp> {
    using OpConversionPattern<pto::TColExpandExpdifOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::TColExpandExpdifOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOColExpandSubToEmitC : public OpConversionPattern<pto::TColExpandSubOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TColExpandSubOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOColExpandMaxToEmitC : public OpConversionPattern<pto::TColExpandMaxOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TColExpandMaxOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOColExpandMinToEmitC : public OpConversionPattern<pto::TColExpandMinOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TColExpandMinOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOTTriToEmitC : public OpConversionPattern<pto::TTriOp> {
    ...
    LogicalResult matchAndRewrite(pto::TTriOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        auto* ctx = rewriter.getContext();
...
struct PTOCmpToEmitC : public OpConversionPattern<pto::TCmpOp> {
    ...
    LogicalResult matchAndRewrite(pto::TCmpOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        auto* ctx = rewriter.getContext();
        ...
        Value modeVal = rewriter.create<emitc::ConstantOp>(loc, modeTy, emitc::OpaqueAttr::get(ctx, tok));
...
struct PTOCmpSToEmitC : public OpConversionPattern<pto::TCmpSOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TCmpSOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        auto* ctx = rewriter.getContext();
...
struct PTOColMaxToEmitC : public OpConversionPattern<pto::TColMaxOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TColMaxOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOColArgMaxToEmitC : public OpConversionPattern<pto::TColArgMaxOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TColArgMaxOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOColMinToEmitC : public OpConversionPattern<pto::TColMinOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TColMinOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOColArgMinToEmitC : public OpConversionPattern<pto::TColArgMinOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TColArgMinOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOColSumToEmitC : public OpConversionPattern<pto::TColSumOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TColSumOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        auto* ctx = rewriter.getContext();
        ...
        if (op.getTmp()) {
            ...
            Value isBinaryVal = rewriter.create<emitc::ConstantOp>(loc, boolTy, emitc::OpaqueAttr::get(ctx, tok));
...
struct PTOColProdToEmitC : public OpConversionPattern<pto::TColProdOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TColProdOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOCvtToEmitC : public OpConversionPattern<pto::TCvtOp> {
    ...
    LogicalResult matchAndRewrite(pto::TCvtOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        auto* ctx = rewriter.getContext();
        ...
        std::string rmTok = rmAttr ? roundModeTok(rmAttr) : std::string("RoundMode::CAST_RINT");
        auto rmodeTy = emitc::OpaqueType::get(ctx, "RoundMode");
        Value rmodeVal = rewriter.create<emitc::ConstantOp>(loc, rmodeTy, emitc::OpaqueAttr::get(ctx, rmTok));

        auto satModeTy = emitc::OpaqueType::get(ctx, "SaturationMode");
        auto satAttr = op.getSatModeAttr();
        std::string satTok = satAttr ? saturationModeTok(satAttr) : std::string("SaturationMode::OFF");
        Value satModeVal = rewriter.create<emitc::ConstantOp>(loc, satModeTy, emitc::OpaqueAttr::get(ctx, satTok));
...
struct PTORandomToEmitC : public OpConversionPattern<pto::TRandomOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TRandomOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        auto* ctx = rewriter.getContext();
        ...
        ArrayAttr templateArgs = rewriter.getArrayAttr({emitc::OpaqueAttr::get(ctx, std::to_string(op.getRounds()))});
...
struct PTODivToTDIV : public OpConversionPattern<pto::TDivOp> {
    ...
    LogicalResult matchAndRewrite(pto::TDivOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        Value src0 = peelUnrealized(adaptor.getSrc0());
        Value src1 = peelUnrealized(adaptor.getSrc1());
        Value dst = peelUnrealized(adaptor.getDst());
        ...
        rewriter.create<emitc::CallOpaqueOp>(
            op.getLoc(), TypeRange{}, "TDIV", ArrayAttr{}, ArrayAttr{}, ValueRange{dst, src0, src1});
...
struct PTODivSToEmitC : public OpConversionPattern<pto::TDivSOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TDivSOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
...
struct PTOExpToEmitC : public OpConversionPattern<pto::TExpOp> {
    ...
    LogicalResult matchAndRewrite(pto::TExpOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        ...
        rewriter.create<emitc::CallOpaqueOp>(loc, TypeRange{}, "TEXP", ArrayAttr{}, ArrayAttr{}, ValueRange{dst, src});
...
struct PTOExpandsToEmitC : public OpConversionPattern<pto::TExpandsOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TExpandsOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        ...
        rewriter.create<emitc::CallOpaqueOp>(
            loc, TypeRange{}, "TEXPANDS", ArrayAttr{}, ArrayAttr{}, ValueRange{dst, scalar});
...
struct PTOExtractToEmitC : public OpConversionPattern<pto::TExtractOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TExtractOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOExtractFPToEmitC : public OpConversionPattern<pto::TExtractFPOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TExtractFPOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOInsertToEmitC : public OpConversionPattern<pto::TInsertOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TInsertOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOInsertFPToEmitC : public OpConversionPattern<pto::TInsertFPOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TInsertFPOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOFillPadToEmitC : public OpConversionPattern<pto::TFillPadOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TFillPadOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOFillPadInplaceToEmitC : public OpConversionPattern<pto::TFillPadInplaceOp> {
    using OpConversionPattern<pto::TFillPadInplaceOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::TFillPadInplaceOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOFillPadExpandToEmitC : public OpConversionPattern<pto::TFillPadExpandOp> {
    using OpConversionPattern<pto::TFillPadExpandOp>::OpConversionPattern;

    LogicalResult matchAndRewrite(
        pto::TFillPadExpandOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOGatherToEmitC : public OpConversionPattern<pto::TGatherOp> {
    ...
    static FailureOr<std::string> getOpaqueTok(
        ConversionPatternRewriter& rewriter, pto::TGatherOp op, Value value, StringRef name)
    {
    ...
    static void rewriteIndexForm(
        ConversionPatternRewriter& rewriter, Location loc, pto::TGatherOp op, Value dst, Value src0, Value idx,
        Value tmp)
    {
        rewriter.create<emitc::CallOpaqueOp>(
    ...
    static LogicalResult rewriteCompareForm(
        ConversionPatternRewriter& rewriter, Location loc, MLIRContext* ctx, pto::TGatherOp op, Value dst, Value src0,
        Value cdst, Value tmp, Value kValue)
    {
    ...
    static LogicalResult rewriteMaskForm(
        ConversionPatternRewriter& rewriter, Location loc, MLIRContext* ctx, pto::TGatherOp op, Value dst, Value src0)
    {
        ...
        std::string mpTok = std::string("MaskPattern::") + mlir::pto::stringifyMaskPattern(mp.getValue()).str();
        auto targs = rewriter.getArrayAttr({
            emitc::OpaqueAttr::get(ctx, *dstTokOr),
            emitc::OpaqueAttr::get(ctx, *srcTokOr),
    ...
    LogicalResult matchAndRewrite(
        pto::TGatherOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        auto* ctx = rewriter.getContext();
        ...
        if (Value cdst = adaptor.getCdst()) {
            ...
            return rewriteCompareForm(rewriter, loc, ctx, op, dst, src0, cdst, tmp, kValue);
        }
...
struct PTOGatherbToEmitC : public OpConversionPattern<pto::TGatherBOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TGatherBOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOLogToEmitC : public OpConversionPattern<pto::TLogOp> {
    ...
    LogicalResult matchAndRewrite(pto::TLogOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOLReluToEmitC : public OpConversionPattern<pto::TLReluOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TLReluOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOMaxToEmitC : public OpConversionPattern<pto::TMaxOp> {
    ...
    LogicalResult matchAndRewrite(pto::TMaxOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOMaxSToEmitC : public OpConversionPattern<pto::TMaxSOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TMaxSOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOMinToEmitC : public OpConversionPattern<pto::TMinOp> {
    ...
    LogicalResult matchAndRewrite(pto::TMinOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOMinsToEmitC : public OpConversionPattern<pto::TMinSOp> {
    ...
    LogicalResult matchAndRewrite(
        pto::TMinSOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
...
struct PTOMovToEmitC : public OpConversionPattern<pto::TMovOp> {
    ...
    static LogicalResult appendTMovFpOrScalarArgs(
        ConversionPatternRewriter& rewriter, pto::TMovOp op, Value fp, Value preQuantScalar, StringRef& callee,
        SmallVectorImpl<Value>& operands, SmallVectorImpl<Attribute>& templateArgVec)
    {
        auto* ctx = rewriter.getContext();
        ...
        if (fp) {
            ...
            if (!fpOT)
                return rewriter.notifyMatchFailure(op, "tmov fp lowering expects opaque fp type");
            operands.push_back(fp);
            templateArgVec.push_back(emitc::OpaqueAttr::get(ctx, fpOT.getValue().str()));
            if (hasMode)
                templateArgVec.push_back(emitc::OpaqueAttr::get(ctx, modeTok(modeAttr.getValue())));
            if (hasMode || reluNonDefault)
                templateArgVec.push_back(emitc::OpaqueAttr::get(ctx, reluTok(op.getReluPreMode())));
    ...
    static FailureOr<ArrayAttr> buildTMovTemplateArgs(
        ConversionPatternRewriter& rewriter, pto::TMovOp op, Value src, Value dst, Value fp, Value preQuantScalar,
        StringRef& callee, SmallVectorImpl<Value>& operands)
    {
        auto* ctx = rewriter.getContext();
        auto dstOT = mlir::dyn_cast<emitc::OpaqueType>(dst.getType());
        auto srcOT = mlir::dyn_cast<emitc::OpaqueType>(src.getType());
        if (!dstOT || !srcOT)
            return rewriter.notifyMatchFailure(op, "tmov lowering expects opaque dst/src types");
        ...
        callee = "TMOV";
        if (failed(appendTMovFpOrScalarArgs(rewriter, op, fp, preQuantScalar, callee, operands, templateArgVec)))
            return failure();
        ...
        if (templateArgVec.size() == kNumber2 && !hasFp && !hasPreQuant && !hasMode && !reluNonDefault)
            return ArrayAttr{};
        return rewriter.getArrayAttr(templateArgVec);
    }

    LogicalResult matchAndRewrite(pto::TMovOp op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override
    {
        auto loc = op.getLoc();
        ...
        FailureOr<ArrayAttr> templateArgs =
            buildTMovTemplateArgs(rewriter, op, src, dst, fp, preQuantScalar, callee, operands);
...
void populatePTOToEmitCTilePatterns(RewritePatternSet& patterns, TypeConverter& typeConverter, MLIRContext* ctx)
{
    ...
    patterns.add<PTOExtractToEmitC, PTOExtractFPToEmitC, PTOInsertToEmitC, PTOInsertFPToEmitC>(typeConverter, ctx);
    patterns.add<PTOFillPadToEmitC, PTOFillPadInplaceToEmitC, PTOFillPadExpandToEmitC>(typeConverter, ctx);
